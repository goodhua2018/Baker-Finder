...
function renderSearchList() {
  if (state.loggedInEmail === null) {
    ...
    document.querySelector('#page').innerHTML = `
      <div class = "row">
        <section class="col-md-8 col-sm-1 col-lg-8 card-group m-3">
        ...
        <aside class = "col-md-3 col-sm-1 col-lg-3">
          ...
          <div class="baker-list card-group m-3">
...
function renderSearchs() {
  return state.searches.map(baker => `  
    <div 
      ...
      data-id='${baker.id}' 
      data-img='${baker.img}' 
      data-name='${baker.name}' 
      data-address='${baker.address}' 
      data-suburb='${baker.suburb}' 
      data-postcode='${baker.postcode}' 
      data-contact='${baker.contact}' 
      data-specialty='${baker.specialty}'
    >
...
function renderSearchError() {
  if (state.loggedInEmail === null) {
    ...
    document.querySelector('#page').innerHTML = `
      <div class = "row">
        <section class="col-md-8 col-sm-1 col-lg-8 card-group m-3">
          Sorry! There is no baker in this area.
        </section> 
        <aside class = "col-md-3 col-sm-1 col-lg-3">
          <header class = "row d-block">
            <h3>${state.loggedInName}</h3>
